# Jest Environment for TestMu AI (Formerly LambdaTest)
...
The Jest Environment for TestMu AI (Formerly LambdaTest) provides a Jest custom test environment that connects to the TestMu AI cloud grid, enabling you to use Jest as a test runner for cross-browser visual and Selenium automation tests across real browsers and operating systems.
